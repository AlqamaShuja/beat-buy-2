            ...
            <Link to={`/event/${event.id}`} className="w-100" style={{ textDecoration: 'none' }}>
                ...
                >
                    ...
                    <div className="event_text p-2 d-flex flex-column flex-grow-1">
                        <h4 className="text-lg font-semibold text-gray-800 truncate" style={{ fontSize: '24px', color: 'white', lineHeight: '1.3' }}>{event.name}</h4>
                        <div className="event_time mt-4 space-y-2 text-gray-600 text-sm">
                            {/* Venue Information */}
                            <p className="truncate d-flex gap-2 align-items-center">
                                <MdOutlineCalendarToday style={{ fontSize: '24px' }} />
                                <span style={{ color: '#47B5F5', fontSize: '18px' }}>
