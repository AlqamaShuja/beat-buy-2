            ...
            <div className="row justify-content-center">
              <div className="col-lg-6" style={{ marginTop: "150px" }}>
                <div className="user_info">
                  <div className="user_infoo_title" style={{ marginBottom: '100px', }}>
                    <h5>Reset Password</h5>
                    <span style={{ color: "#fff" }}>
                      If we find the account associated with the email, you
                      will <br /> receive a code to complete your password
                      reset.
                    </span>
                  </div>
